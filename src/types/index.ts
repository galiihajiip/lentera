...
//
// POLA RUNTIME VALIDATION:
// `LENS_TYPES` adalah const array — single source of truth.
// `LensType` di-derive dari array agar tidak ada duplikasi.
// Gunakan `LENS_TYPES.includes(x as LensType)` untuk runtime check.
// ═══════════════════════════════════════════════════
...
/** Union type semua lensa budaya yang valid. Derived dari LENS_TYPES — single source of truth. */
